...
[![Version: 2.4.0~ynh1](https://img.shields.io/badge/Version-2.4.0~ynh1-rgb(18,138,11)?style=for-the-badge)](https://ci-apps.yunohost.org/ci/apps/stirling-pdf/)
...
```bash
sudo yunohost app setting stirling-pdf upgrade_channel -v testing
```
